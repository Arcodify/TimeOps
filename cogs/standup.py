...
class Standup(commands.Cog):
    ...
    async def standup_add(
        ...
        standup_id = await self.db.add_standup(
    ...
    async def standup_list(self, interaction: discord.Interaction):
        standups = await self.db.get_standups(str(interaction.guild_id), active_only=False)
    ...
    @app_commands.checks.has_permissions(manage_guild=True)
    async def standup_delete(self, interaction: discord.Interaction, standup_id: int):
        await self.db.delete_standup(standup_id)
    ...
    @app_commands.checks.has_permissions(manage_guild=True)
    async def standup_toggle(self, interaction: discord.Interaction, standup_id: int, active: bool):
        await self.db.toggle_standup(standup_id, active)
    ...
    @app_commands.checks.has_permissions(manage_guild=True)
    async def standup_test(self, interaction: discord.Interaction, standup_id: int):
        standups = await self.db.get_standups(str(interaction.guild_id), active_only=False)
